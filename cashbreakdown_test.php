...
<div class="listview">
	<?php
		...
		$SDChargeWater = $SDShortWater - $SDAdjWater;
    ...
    <div class="group" style="padding-left: 100px">CASH COUNT</div>
        ...
        <div class="misdenocol" style="width:auto; border-left:#999 solid thin; margin-left:1%; height:100%;">
            ...
            <div style="height:23px">
            	...
            	<div class="misdenoholder" style="margin-left: 20px;"><input class="misdenomination" style="max-width:120px;text-align:right;" type="text" id="txt-adjwater" name="txt-adjwater" placeholder="0" value="<?php if($SDAdjWater<=0){echo  number_format($SDAdjWater,2,'.',',');}else{echo  number_format($SDAdjWater,2,'.',',');}  ?>"/></div>
            ...
            <div style="height:46px; width:400px; padding-bottom: 23px">
    ...
    <div class="misdenocol" style="width:auto;margin-left:5%;">
         <table id="crewonduty">
             ...
             <?php
			 	for($i=1;$i<9;$i++){
					$ifExists=ExecuteReader("Select unSalesCrew as `result` From salescrew Where unSalesCrew=".$i." AND `unBranch`=".$_SESSION['bid']." AND `unInventoryControl`=".$_SESSION['did']."");
