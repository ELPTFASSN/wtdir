								...
								GROUP BY Employee ORDER BY ELastName")){
									...
									while ($stmtemp->fetch()) {
										if($SCCode1!='SP'||$SCCode1!='T'||$SCCode1!='F'){
												echo '<tr class="rptrow"><th class="rptcrew rptccrew" style="text-align:left; padding-left:90px;"><input type="hidden" style="display:none" name="repcrewname-'.$i.'-'.$j.'" id="repcrewname-'.$i.'-'.$j.'" value="'.$Employee.'"><b>'.$Employee.'</b></th>
												<td><input placeholder="0.00" id="repcrewhr-'.$i.'-'.$j.'" name="repcrewhr-'.$i.'-'.$j.'" name="repcrewhr-'.$i.'-'.$j.'" readonly style="text-align:center; background:#EEE" value="'.$Hours.'"></td>
											...
											$OSString = $OSString.'<tr class="rptrow"><th class="rptcrew" style="text-align:left; padding-left:90px;"><input type="hidden" style="display:none" id="reposname-'.$i.'-'.$os.'" name="reposname-'.$i.'-'.$os.'" class="reposname  reposnewname-'.$i.'" value="'.$Employee.'"><b>'.$Employee.'</b></th>
				...
				?></table> </form>
					 <div class="rptsum" id="incentivesrptsum" style=" width:100%; padding:50px 0; position: relative; display: inline-block; margin:50px 0; border-top: #000 thick dashed;">
						 ...
						 <table style="width:60%; margin:70px 20%; border: none; border-collapse: collapse;">
						 	...
						 	<tr><th><input type="text" value="Carolyn A. Indencia" style="text-align: center"></th><th></th><th><input type="text" value="Ajie C. Tudeja" style="text-align: center"></th></tr>
						 	<tr><th>Acct. Officer</th><th></th><th>Bus. Unit Accountant</th></tr>
						 	<tr><th></th><td>Received by:</td><th></th></tr>
						 	<tr  style="height: 50px"></tr>
						 	<tr><th><input type="text" value="Dexter Sagaya" style="text-align: center"></th><th><input type="text" value="Ethel Leigh Chin" style="text-align: center"></th><th><input type="text" value="Christina Tuya" style="text-align: center"></th></tr>
						 	<tr><th>Asst. Payroll Officer</th><th>Opt. Director</th><th>HR National Manager</th></tr>
						 </table>
				</div> 
				<?PHP
			}else{
